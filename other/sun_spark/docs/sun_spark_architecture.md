# SUN_SPARK Architectural Documentation
...
- Compare against original Sun datasheet
...
- [WikiChip](https://en.wikichip.org/wiki/other/sun_spark)
- [Wikipedia](https://en.wikipedia.org/wiki/sun spark)
