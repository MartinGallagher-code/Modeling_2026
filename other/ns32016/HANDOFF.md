...
- National Semiconductor's early 32-bit CISC processor (1982). Complex addressing modes with variable-length instructions. Heavily microcoded execution pipeline.
