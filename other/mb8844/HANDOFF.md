...
The Fujitsu MB8844 (1977) is an MB8841 variant with expanded I/O:
- Same instruction set and timing as MB8841
- Additional I/O ports for peripheral-heavy applications
...
| io | 4 | I/O operations (expanded ports) |
