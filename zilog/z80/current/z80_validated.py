#!/usr/bin/env python3
"""
Zilog Z80 Validated Performance Model

Most popular 8-bit CPU ever
...
@dataclass
class Z80Specs:
    """Validated Zilog Z80 specifications."""
    name: str = "Zilog Z80"
    year: int = 1976
...
class Z80Model:
    """
    Validated performance model for Zilog Z80.
    ...
    def __init__(self):
        self.specs = Z80Specs()
        self.workloads = {
            'typical': Z80Workload('typical', 0.3, 0.5, 0.2),
            'compute': Z80Workload('compute', 0.5, 0.4, 0.1),
            'control': Z80Workload('control', 0.2, 0.4, 0.4),
        }
    
    def analyze(self, workload: str = 'typical',
                clock_mhz: float = 2.5) -> Z80Result:
