...
class Motorola6809CPIStackModel:
    """
    CPI Stack Model for Motorola 6809.
    ...
    def print_result(self, result: CPIStackResult):
        ...
        print(f"\n{'='*55}")
        print(f"CPI STACK: Motorola 6809")
        print(f"{'='*55}")
...
def main():
    model = Motorola6809CPIStackModel()
    
    print("\n" + "="*55)
    print("Motorola 6809 CPI STACK MODEL")
    print("="*55)
