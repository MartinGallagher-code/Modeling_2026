...
class Intel8088CPIStackModel:
    """
    CPI Stack Model for Intel 8088.
...
def main():
    model = Intel8088CPIStackModel()
    
    print("\n" + "="*55)
    print("Intel 8088 CPI STACK MODEL")
    print("="*55)
