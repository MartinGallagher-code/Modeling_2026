...
class Motorols6800CPIStackModel:
    """
    CPI Stack Model for Motorola 6800.
    ...
    def print_result(self, result: CPIStackResult):
        ...
        print(f"\n{'='*55}")
        print(f"CPI STACK: Motorola 6800")
        print(f"{'='*55}")
...
def main():
    model = Motorols6800CPIStackModel()
    
    print("\n" + "="*55)
    print("Motorola 6800 CPI STACK MODEL")
    print("="*55)
