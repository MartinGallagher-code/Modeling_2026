...
class NecV20CPIStackModel:
    """
    CPI Stack Model for NEC V20.
...
def main():
    model = NecV20CPIStackModel()
    
    print("\n" + "="*55)
    print("NEC V20 CPI STACK MODEL")
    print("="*55)
