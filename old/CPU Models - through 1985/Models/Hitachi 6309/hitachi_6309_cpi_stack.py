...
class Hitachi6309CPIStackModel:
    """
    CPI Stack Model for Hitachi 6309.
    ...
    def print_result(self, result: CPIStackResult):
        ...
        print(f"\n{'='*55}")
        print(f"CPI STACK: Hitachi 6309")
        print(f"{'='*55}")
...
def main():
    model = Hitachi6309CPIStackModel()
    
    print("\n" + "="*55)
    print("Hitachi 6309 CPI STACK MODEL")
    print("="*55)
