#!/usr/bin/env python3
"""
IBM POWER2 Grey-Box Queueing Model
==================================

Architecture: Enhanced POWER, 8-chip MCM, top TPC benchmarks
Year: 1993, Clock: 71.5 MHz
...
class IbmPower2Model(BaseProcessorModel):
    """
    IBM POWER2 Grey-Box Queueing Model

    Enhanced POWER, 8-chip MCM, top TPC benchmarks (1993)
    - Superscalar
    - 8-chip MCM
    - Dual FPU
    """
    ...
    def __init__(self):
        ...
        self.corrections = {
            'alu': 0.7513023965583,
            'branch': -0.03812417859174067,
            'divide': -5.054620759723135,
            'load': -3.5525190351769393,
            'multiply': -4.999999999505087,
            'store': 3.1873932309776953,
        }
