...
class IbmPower1Model(BaseProcessorModel):
    """
    IBM POWER1 Grey-Box Queueing Model

    Original POWER architecture, RS/6000, foundation of PowerPC (1990)
    - Multi-chip design
    - Branch processor
    - FXU+FPU+BRU
    """
    ...
    def __init__(self):
        self.instruction_categories = {
            ...
            'divide': InstructionCategory('divide', 13.0, 0, "Divide"),
        }
        ...
        self.corrections = {
            'alu': 0.9004476123174454,
            'branch': 0.2938444458720557,
            'divide': -8.673139721901014,
            'load': -2.671366636686797,
            'multiply': -3.739171386354876,
            'store': 2.484760278098992,
        }
