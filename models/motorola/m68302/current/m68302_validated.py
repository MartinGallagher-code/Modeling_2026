#!/usr/bin/env python3
"""
Motorola MC68302 IMP Grey-Box Queueing Model
============================================

Architecture: Integrated Multiprotocol Processor, 68k + 3 serial
Year: 1989, Clock: 16.0 MHz
...
class M68302Model(BaseProcessorModel):
    """
    Motorola MC68302 IMP Grey-Box Queueing Model

    Integrated Multiprotocol Processor, 68k + 3 serial (1989)
    - 68000 core
    - 3 serial channels
    - HDLC/SDLC/async
    """

    name = "Motorola MC68302 IMP"
    ...
    def __init__(self):
        ...
        self.corrections = {
            'control': -0.1854136874361631,
            'dma': 0.9118283963227846,
            'memory': -0.32834525025537037,
            'packet': -1.2097242083758946,
            'protocol': -1.2097242083758972,
            'register': 1.717344228804917,
        }
