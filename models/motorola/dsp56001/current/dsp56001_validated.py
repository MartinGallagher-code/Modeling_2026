#!/usr/bin/env python3
"""
Motorola DSP56001 Grey-Box Queueing Model
=========================================

Architecture: 24-bit fixed-point, NeXT sound, pro audio standard
Year: 1987, Clock: 27.0 MHz
...
class Dsp56001Model(BaseProcessorModel):
    """
    Motorola DSP56001 Grey-Box Queueing Model

    24-bit fixed-point, NeXT sound, pro audio standard (1987)
    - 24-bit data path
    - Dual Harvard
    - Single-cycle MAC
    """

    name = "Motorola DSP56001"
