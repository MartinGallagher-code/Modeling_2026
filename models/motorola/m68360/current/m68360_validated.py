#!/usr/bin/env python3
"""
Motorola MC68360 QUICC Grey-Box Queueing Model
==============================================

Architecture: Quad Integrated Communications Controller
Year: 1993, Clock: 25.0 MHz
...
class M68360Model(BaseProcessorModel):
    """
    Motorola MC68360 QUICC Grey-Box Queueing Model

    Quad Integrated Communications Controller (1993)
    - CPU32 core
    - 4 serial channels
    - QUICC engine
    """

    name = "Motorola MC68360 QUICC"
    ...
    def __init__(self):
        self.instruction_categories = {
            'packet': InstructionCategory('packet', 3.0, 0, "Packet processing"),
            'dma': InstructionCategory('dma', 2.0, 0, "DMA transfer"),
            'register': InstructionCategory('register', 1.0, 0, "Register access"),
            'memory': InstructionCategory('memory', 2.0, 0, "Buffer memory"),
            'control': InstructionCategory('control', 3.0, 0, "Flow control"),
            'protocol': InstructionCategory('protocol', 3.0, 0, "Protocol engine"),
        }
