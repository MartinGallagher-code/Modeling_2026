...
class M68881Model(BaseProcessorModel):
    ...
    def __init__(self):
        ...
        self.corrections = {
            'fp_add': -0.4535370057497912,
            'fp_div': -12.506350602183131,
            'fp_move': 4.255514715205455,
            'fp_mul': 5.000264062883197,
            'fp_sqrt': -17.496214384704693,
            'fp_trig': -27.500705605604786,
        }
