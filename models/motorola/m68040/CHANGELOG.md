...
- Corrections: alu_reg: -2.25, control: -0.21, data_transfer: +3.48, divide: -17.67, fp_ops: -4.69, memory: -0.55, multiply: -4.52
...
1. Updated measured_cpi.json with externally-validated benchmark data
  ...
  - dhrystone: 19.05 DMIPS @ 33.0MHz → CPI=1.73
  - mips_rating: 44.0 MIPS @ 40.0MHz → CPI=0.91
