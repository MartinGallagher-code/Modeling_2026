#!/usr/bin/env python3
"""
Motorola 88100 Grey-Box Queueing Model
======================================
...
class M88100Model(BaseProcessorModel):
    """
    Motorola 88100 Grey-Box Queueing Model

    Motorola's own RISC, Harvard architecture (1988)
    ...
    def __init__(self):
        self.instruction_categories = {
            ...
            'divide': InstructionCategory('divide', 21.0, 0, "Divide"),
        }
        ...
        self.corrections = {
            'alu': 1.265397704398478,
            'branch': -0.662357088811801,
            'divide': -15.023583122760447,
            'load': -3.916498865047759,
            'multiply': -7.301131054863158,
            'store': 3.96941687723958,
        }
