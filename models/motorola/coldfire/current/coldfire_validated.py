#!/usr/bin/env python3
"""
Motorola ColdFire Grey-Box Queueing Model
=========================================

Architecture: Variable-length RISC based on 68k ISA subset
Year: 1994, Clock: 33.0 MHz
...
class ColdfireModel(BaseProcessorModel):
    """
    Motorola ColdFire Grey-Box Queueing Model

    Variable-length RISC based on 68k ISA subset (1994)
    - 68k ISA subset
    - 2-stage pipeline
    - MAC unit
    """

    name = "Motorola ColdFire"
    manufacturer = "Motorola"
    year = 1994
    clock_mhz = 33.0
    transistor_count = 650000
    data_width = 32
    address_width = 32
    ...
    def __init__(self):
        self.instruction_categories = {
            ...
            'divide': InstructionCategory('divide', 10.0, 0, "Divide"),
        }
        ...
        self.corrections = {
            'alu': 1.172968274325906,
            'branch': -0.5215701061535158,
            'divide': -5.0390154391307584,
            'load': -3.001729683437765,
            'multiply': -4.998051468953852,
            'store': 2.9114576897675684,
        }
