#!/usr/bin/env python3
"""
Motorola 88110 Grey-Box Queueing Model
======================================
...
class M88110Model(BaseProcessorModel):
    """
    Motorola 88110 Grey-Box Queueing Model

    Superscalar 88k, 2-issue, on-chip caches (1991)
    - 2-issue superscalar
    - On-chip caches
    - Integrated FPU
    """
    ...
    def __init__(self):
        ...
        self.corrections = {
            'alu': 0.7427505717589638,
            'branch': 0.084871090839006,
            'divide': -10.625731504561235,
            'load': -2.8204070923808313,
            'multiply': -5.204526313760762,
            'store': 2.771568495438782,
        }
