#!/usr/bin/env python3
"""
HP PA-7200 Grey-Box Queueing Model
==================================

Architecture: Superscalar PA-RISC, dual-issue
Year: 1994, Clock: 140.0 MHz
...
class Pa7200Model(BaseProcessorModel):
    """
    HP PA-7200 Grey-Box Queueing Model

    Superscalar PA-RISC, dual-issue (1994)
    ...
    def __init__(self):
        ...
        self.corrections = {
            'alu': 0.5213931154835474,
            'branch': -0.2317837171016479,
            'divide': -5.458753144701456,
            'load': -2.892908245574793,
            'multiply': -4.999953541047924,
            'store': 3.522609201353381,
        }
