#!/usr/bin/env python3
"""
HP PA-7100LC Grey-Box Queueing Model
====================================
...
class Pa7100lcModel(BaseProcessorModel):
    """
    HP PA-7100LC Grey-Box Queueing Model

    Low-cost PA-RISC with on-chip cache/memory controller (1994)
    - On-chip cache
    - Memory controller
    - Low cost
    """
    ...
    def __init__(self):
        ...
        self.corrections = {
            'alu': 0.9249473484274652,
            'branch': -0.7116275502859439,
            'divide': -9.242404072201508,
            'load': -4.951592181047362,
            'multiply': -4.999999999638126,
            'store': 0.799126833759304,
        }
