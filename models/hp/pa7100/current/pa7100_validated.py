#!/usr/bin/env python3
"""
HP PA-7100 Grey-Box Queueing Model
==================================

Architecture: Second-gen PA-RISC, multimedia instructions
Year: 1992, Clock: 100.0 MHz
...
class Pa7100Model(BaseProcessorModel):
    """
    HP PA-7100 Grey-Box Queueing Model

    Second-gen PA-RISC, multimedia instructions (1992)
    - PA-RISC 1.1
    - Multimedia
    - External cache
    """
    ...
    def __init__(self):
        ...
        self.corrections = {
            'alu': 0.6486737302325586,
            'branch': 0.10482678449612236,
            'divide': -8.175938486821712,
            'load': -1.806079925581396,
            'multiply': -3.614407944186047,
            'store': 2.816619113178298,
        }
