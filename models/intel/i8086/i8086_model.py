...
Grey-box queueing model for the Intel 8086 microprocessor (1978).
...
TIMING_CATEGORIES = {
    ...
    'mov_reg_mem': {
        'cycles': 12,
        'weight': 0.15,
        'description': 'MOV r,m with EA calc',
        'source': 'Intel 8086 Family Users Manual'
    },
    'alu_register': {
        'cycles': 3,
...
VALIDATION_TARGETS = {
    ...
    'cpi_min': 7,
    'cpi_max': 15,
    'expected_bottlenecks': ['ea_calc', 'prefetch'],
    'source': 'Intel 8086 Family Users Manual'
}
