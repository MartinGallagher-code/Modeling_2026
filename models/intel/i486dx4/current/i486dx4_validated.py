#!/usr/bin/env python3
"""
Intel 486DX4 Grey-Box Queueing Model
====================================

Clock-tripled 486, 16KB L1 cache, 100MHz
Year: 1994, Clock: 100.0 MHz
...
class I486DX4Model(BaseProcessorModel):
    """
    Intel 486DX4 Grey-Box Queueing Model
    Target CPI: 1.8
    """
    ...
    def __init__(self):
        self.instruction_categories = {
            'alu': InstructionCategory('alu', 1.0, 0, "ALU @1 cycle"),
            'data_transfer': InstructionCategory('data_transfer', 1.0, 0, "MOV @1 cycle"),
            'memory': InstructionCategory('memory', 2.0, 0, "Memory (cache hit)"),
            'control': InstructionCategory('control', 3.5, 0, "Branch"),
            'multiply': InstructionCategory('multiply', 12.0, 0, "MUL"),
            'divide': InstructionCategory('divide', 38.0, 0, "DIV"),
        }
        ...
        self.corrections = {
            'alu': 0.7999999999999863,
            'control': -1.6999999999999857,
            'data_transfer': 0.8000000000000071,
            'divide': -18.20000000000003,
            'memory': -18.20000000000003,
            'multiply': -10.199999999999989,
        }
