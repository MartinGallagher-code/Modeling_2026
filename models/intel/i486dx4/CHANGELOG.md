...
**Session goal:** Create initial grey-box queueing model for Intel 486DX4
...
**What we learned:**
- Intel 486DX4 (1994) is a 32-bit processor at 100.0 MHz
...
1. Updated measured_cpi.json with externally-validated benchmark data
  ...
  - dhrystone: 44.4 DMIPS @ 100.0MHz → CPI=2.25
