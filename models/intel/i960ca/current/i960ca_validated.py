...
class I960caModel(BaseProcessorModel):
    """
    Intel i960CA Grey-Box Queueing Model

    Superscalar i960, 3-issue, RAID controller standard (1989)
    - 3-issue superscalar
    - 1KB I-cache
    - Register scoreboard
    """
    ...
    def __init__(self):
        ...
        self.corrections = {
            'alu': 0.1762201336245683,
            'branch': -0.1585921495567275,
            'divide': -5.484530733650277,
            'load': -1.8267351406912533,
            'multiply': -2.83265356546319,
            'store': 1.0191692663497436,
        }
