#!/usr/bin/env python3
"""
Intel i960 Grey-Box Queueing Model
==================================
...
class I960Model(BaseProcessorModel):
    """
    Intel i960 Grey-Box Queueing Model

    32-bit embedded RISC, register scoreboarding (1988)
    ...
    def __init__(self):
        ...
        self.corrections = {
            'alu': 0.8140721658315134,
            'branch': -0.5666213685097166,
            'divide': -6.663153696803576,
            'load': -1.9060487387040115,
            'multiply': -3.4700890402158557,
            'store': 1.3298463031964243,
        }
