#!/usr/bin/env python3
"""
Intel 8748 Grey-Box Queueing Model
==================================

Architecture: Microcontroller (1977)
EPROM version of 8048.

Features:
  - Same as 8048 but with EPROM
...
class I8748Model(BaseProcessorModel):
    """
    Intel 8748 Grey-Box Queueing Model

    EPROM version of 8048 (1977)
    - Same timing as 8048
    """
    ...
    def __init__(self):
        ...
        self.corrections = {
            'alu': -0.23181818181818456,
            'control': -0.34545454545454546,
            'data_transfer': 0.6090909090909097,
            'memory': -0.43636363636363684,
            'multiply': -2.4590909090908974,
        }
