#!/usr/bin/env python3
"""
Intel 486SX Grey-Box Queueing Model
===================================

486 without FPU, 8KB cache, 5-stage pipeline
Year: 1991, Clock: 25.0 MHz
...
class I486SXModel(BaseProcessorModel):
    """
    Intel 486SX Grey-Box Queueing Model
    Target CPI: 2.0
    """
    ...
    def __init__(self):
        self.instruction_categories = {
            ...
            'multiply': InstructionCategory('multiply', 13.0, 0, "MUL (no FPU)"),
