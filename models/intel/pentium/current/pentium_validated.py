...
Architecture: Superscalar CISC (1993)
...
Target CPI: 1.0 (superscalar, >1 IPC possible)
"""
...
class PentiumModel(BaseProcessorModel):
    """
    Intel Pentium Grey-Box Queueing Model
    ...
    def __init__(self):
        # Superscalar - effective cycles often <1 due to parallelism
        self.instruction_categories = {
            'alu': InstructionCategory('alu', 0.5, 0, "ADD/SUB @0.5 (pairable)"),
            'data_transfer': InstructionCategory('data_transfer', 0.5, 0, "MOV @0.5 (pairable)"),
            'memory': InstructionCategory('memory', 1.0, 0, "MOV r,m @1 (cache hit)"),
            'control': InstructionCategory('control', 2.0, 0, "Branch @2.0 (with prediction)"),
            'multiply': InstructionCategory('multiply', 11.0, 0, "MUL @11"),
            'divide': InstructionCategory('divide', 39.0, 0, "DIV @39"),
        }
        ...
        self.corrections = {
            'alu': 0.12367395393504262,
            'control': -0.07224472602303915,
            'data_transfer': 0.5025845807274352,
            'divide': -35.63346452665178,
            'memory': 0.304936662865828,
            'multiply': -16.096065191222866,
        }
