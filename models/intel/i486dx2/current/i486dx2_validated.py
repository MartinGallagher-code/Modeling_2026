#!/usr/bin/env python3
"""
Intel 486DX2 Grey-Box Queueing Model
====================================

Clock-doubled 486, internal 66MHz / external 33MHz bus
Year: 1992, Clock: 66.0 MHz
...
class I486DX2Model(BaseProcessorModel):
    """
    Intel 486DX2 Grey-Box Queueing Model
    Target CPI: 2.0
    """
    ...
    def __init__(self):
        self.instruction_categories = {
            ...
            'control': InstructionCategory('control', 4.0, 0, "Branch"),
            'multiply': InstructionCategory('multiply', 13.0, 0, "MUL"),
