#!/usr/bin/env python3
"""
DEC Alpha 21064A Grey-Box Queueing Model
========================================

Architecture: Faster 21064, 300 MHz
Year: 1994, Clock: 300.0 MHz
...
class Alpha21064aModel(BaseProcessorModel):
    """
    DEC Alpha 21064A Grey-Box Queueing Model

    Faster 21064, 300 MHz (1994)
    - 2-issue
    - 16KB I+D cache
    - 300 MHz
    """
    ...
    def __init__(self):
        ...
        self.corrections = {
            'alu': 0.5641510148426041,
            'branch': -0.877244154663585,
            'divide': -8.670268307132629,
            'load': -2.781265767935238,
            'multiply': -5.084220002194526,
            'store': 0.9705931728673541,
        }
