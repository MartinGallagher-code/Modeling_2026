#!/usr/bin/env python3
"""
Zoran ZR34161 Grey-Box Queueing Model
=====================================
...
class ZoranZr34161Model(BaseProcessorModel):
    """
    Zoran ZR34161 Grey-Box Queueing Model

    JPEG/MPEG decoder DSP, early digital imaging (1991)
    - JPEG/MPEG decode
    - DCT engine
    - Digital imaging
    """
    ...
    def __init__(self):
        self.instruction_categories = {
            ...
            'load': InstructionCategory('load', 2.0, 0, "Data load"),
            'store': InstructionCategory('store', 2.0, 0, "Data store"),
