#!/usr/bin/env python3
"""
Samsung KS86C4004 Grey-Box Queueing Model
=========================================

Architecture: Samsung's 4-bit/8-bit MCU, early Korean semiconductor
Year: 1990, Clock: 10.0 MHz
...
class Ks86c4004Model(BaseProcessorModel):
    """
    Samsung KS86C4004 Grey-Box Queueing Model

    Samsung's 4-bit/8-bit MCU, early Korean semiconductor (1990)
    - Early Korean MCU
    - Samsung Semiconductor
    - Consumer electronics
    """

    name = "Samsung KS86C4004"
