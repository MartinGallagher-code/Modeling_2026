#!/usr/bin/env python3
"""
Analog Devices ADSP-2100 Grey-Box Queueing Model
===================================================

Target CPI: 1.4
Architecture: 16-bit DSP (1986)

The ADSP-2100 was Analog Devices' first digital signal processor,
featuring a pipelined Harvard architecture with single-cycle MAC
(Multiply-Accumulate) capability. It established the ADSP-21xx
family that became widely used in audio, communications, and
...
class Adsp2100Model(BaseProcessorModel):
    """
    Analog Devices ADSP-2100 Grey-Box Queueing Model
    ...
    The ADSP-2100 featured a 3-stage pipeline enabling single-cycle
    execution for core DSP operations (MAC, ALU, shift). Memory and
    I/O operations required additional cycles due to bus contention.
    """

    name = "Analog Devices ADSP-2100"
    ...
    def __init__(self):
        # Typical: 0.30*1 + 0.25*1 + 0.15*1 + 0.10*2 + 0.10*2 + 0.10*3 = 1.40
        self.instruction_categories = {
            ...
            'io': InstructionCategory(
                'io', 3.0, 0,
                "I/O and serial port operations"
            ),
        }
        ...
        self.workload_profiles = {
            'typical': WorkloadProfile('typical', {
                ...
                'control': 0.10,
                'io': 0.10,
            }, "Typical DSP filtering workload"),
    ...
    def validate(self) -> Dict[str, Any]:
        ...
        expected_cycles = {
            'mac': 1.0, 'alu': 1.0, 'shift': 1.0,
            'memory': 2.0, 'control': 2.0, 'io': 3.0,
        }
...
def create_model() -> Adsp2100Model:
    return Adsp2100Model()
