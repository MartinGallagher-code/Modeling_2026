#!/usr/bin/env python3
"""
Hudson HuC6280 Grey-Box Queueing Model
======================================

Architecture: TurboGrafx-16 CPU, enhanced 65C02 with speed modes
Year: 1987, Clock: 7.16 MHz
...
class Huc6280Model(BaseProcessorModel):
    """
    Hudson HuC6280 Grey-Box Queueing Model

    TurboGrafx-16 CPU, enhanced 65C02 with speed modes (1987)
    - Enhanced 65C02
    - Dual speed modes
    - 8KB RAM
    """
