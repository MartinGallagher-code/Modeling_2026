#!/usr/bin/env python3
"""
Ricoh 5A22 Grey-Box Queueing Model
==================================

Architecture: SNES CPU, 65C816 derivative with DMA
Year: 1990, Clock: 3.58 MHz
...
class Ricoh5a22Model(BaseProcessorModel):
    """
    Ricoh 5A22 Grey-Box Queueing Model

    SNES CPU, 65C816 derivative with DMA (1990)
    - 65C816 core
    - DMA controller
    - 3.58 MHz
    """
