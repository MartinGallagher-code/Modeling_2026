#!/usr/bin/env python3
"""
S3 Trio64 Grey-Box Queueing Model
=================================

Integrated VGA + 2D accel + DRAM controller + RAMDAC
Year: 1995, Clock: 75.0 MHz
...
class S3Trio64Model(BaseProcessorModel):
    """
    S3 Trio64 Grey-Box Queueing Model
    Target CPI: 2.0
    """
    ...
    def __init__(self):
        self.instruction_categories = {
            'blit': InstructionCategory('blit', 1.5, 0, "2D BitBLT"),
            'pixel': InstructionCategory('pixel', 1.0, 0, "Pixel write (64-bit)"),
            'line': InstructionCategory('line', 2.0, 0, "Line draw engine"),
            'memory': InstructionCategory('memory', 2.5, 0, "DRAM access"),
            'control': InstructionCategory('control', 3.0, 0, "Mode control"),
            'dac': InstructionCategory('dac', 2.0, 0, "RAMDAC output"),
        }
