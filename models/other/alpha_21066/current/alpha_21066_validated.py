...
class Alpha21066Model(BaseProcessorModel):
    """
    DEC Alpha 21066 Grey-Box Queueing Model

    Low-cost Alpha with integrated PCI/memory controller (1993)
    - Alpha EV4 core
    - Integrated PCI
    - Low-cost Alpha PC
    """

    name = "DEC Alpha 21066"
    manufacturer = "DEC"
    year = 1993
    clock_mhz = 166.0
    transistor_count = 1750000
    data_width = 64
    address_width = 64
