#!/usr/bin/env python3
"""
Ross HyperSPARC Grey-Box Queueing Model
=======================================

Architecture: 3rd-party SPARC, SPARCstation 20
Year: 1993, Clock: 150.0 MHz
...
class HypersparcModel(BaseProcessorModel):
    """
    Ross HyperSPARC Grey-Box Queueing Model

    3rd-party SPARC, SPARCstation 20 (1993)
    - Single-issue
    - 8KB I+D caches
    - Fast clock
    """

    name = "Ross HyperSPARC"
    manufacturer = "Ross/Cypress"
    year = 1993
    clock_mhz = 150.0
    transistor_count = 1800000
    data_width = 32
    address_width = 32
