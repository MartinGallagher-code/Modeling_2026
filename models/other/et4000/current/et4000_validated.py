#!/usr/bin/env python3
"""
Tseng Labs ET4000 Grey-Box Queueing Model
=========================================

Architecture: Fast SVGA with hardware acceleration
Year: 1989, Clock: 40.0 MHz
...
class Et4000Model(BaseProcessorModel):
    """
    Tseng Labs ET4000 Grey-Box Queueing Model

    Fast SVGA with hardware acceleration (1989)
    - SVGA controller
    - Hardware acceleration
    - ISA/VLB
    """

    name = "Tseng Labs ET4000"
