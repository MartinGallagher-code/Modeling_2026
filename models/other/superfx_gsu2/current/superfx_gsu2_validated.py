#!/usr/bin/env python3
"""
Super FX GSU-2 Grey-Box Queueing Model
======================================

Faster Super FX, Doom/Yoshi's Island
Year: 1995, Clock: 21.48 MHz
...
class SuperfxGsu2Model(BaseProcessorModel):
    """
    Super FX GSU-2 Grey-Box Queueing Model
    Target CPI: 2.5
    """
    ...
    def __init__(self):
        self.instruction_categories = {
            ...
            'plot': InstructionCategory('plot', 3.0, 0, "PLOT pixel write"),
            'multiply': InstructionCategory('multiply', 3.0, 0, "Fixed-point multiply"),
            'memory': InstructionCategory('memory', 4.0, 0, "ROM access"),
