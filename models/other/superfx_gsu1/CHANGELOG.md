# Super FX GSU-1 Model Changelog
...
**Session goal:** Create initial grey-box queueing model for Super FX GSU-1
...
**What we learned:**
- Super FX GSU-1 (1993) is a 16-bit processor at 10.74 MHz
