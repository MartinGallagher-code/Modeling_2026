#!/usr/bin/env python3
"""
LSI Logic L64801 Grey-Box Queueing Model
========================================

Architecture: First 3rd-party SPARC, gate-array
Year: 1989, Clock: 25.0 MHz
...
class LsiL64801Model(BaseProcessorModel):
    """
    LSI Logic L64801 Grey-Box Queueing Model

    First 3rd-party SPARC, gate-array (1989)
    - First 3rd-party SPARC
    - Gate array
    - SPARC V7
    """

    name = "LSI Logic L64801"
    ...
    def __init__(self):
        self.instruction_categories = {
            ...
            'divide': InstructionCategory('divide', 18.0, 0, "Divide"),
        }
        ...
        self.corrections = {
            'alu': 1.3761519122874666,
            'branch': -0.3222140420003733,
            'divide': -12.830384270561202,
            'load': -2.7734948820077965,
            'multiply': -6.8140438134395485,
            'store': 3.162615729438808,
        }
