#!/usr/bin/env python3
"""
NexGen Nx586 Grey-Box Queueing Model
====================================

Architecture: x86-compatible RISC core with x86 translation
Year: 1994, Clock: 93.0 MHz
...
class Nx586Model(BaseProcessorModel):
    """
    NexGen Nx586 Grey-Box Queueing Model

    x86-compatible RISC core with x86 translation (1994)
    - RISC86 core
    - x86 translation
    - Proprietary bus
    """
    ...
    def __init__(self):
        self.instruction_categories = {
            ...
            'divide': InstructionCategory('divide', 15.0, 0, "Divide"),
        }
        ...
        self.corrections = {
            'alu': 0.30092992192561363,
            'control': -1.7065750891402645,
            'data_transfer': 0.27823131581770516,
            'divide': -11.40625416414335,
            'memory': -1.5228757669314326,
            'multiply': -4.99185514802448,
        }
