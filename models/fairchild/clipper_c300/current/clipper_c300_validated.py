#!/usr/bin/env python3
"""
Fairchild Clipper C300 Grey-Box Queueing Model
==============================================

Enhanced Clipper with improved cache, CAD workstations
Year: 1988, Clock: 33.0 MHz
...
class ClipperC300Model(BaseProcessorModel):
    """
    Fairchild Clipper C300 Grey-Box Queueing Model
    Target CPI: 1.5
    """

    name = "Fairchild Clipper C300"
