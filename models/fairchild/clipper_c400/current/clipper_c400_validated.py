#!/usr/bin/env python3
"""
Fairchild Clipper C400 Grey-Box Queueing Model
==============================================

Final Clipper, 50MHz, improved FPU, dual-issue hints
Year: 1990, Clock: 50.0 MHz
...
class ClipperC400Model(BaseProcessorModel):
    """
    Fairchild Clipper C400 Grey-Box Queueing Model
    Target CPI: 1.3
    """

    name = "Fairchild Clipper C400"
