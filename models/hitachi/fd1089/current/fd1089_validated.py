...
class FD1089Model(BaseProcessorModel):
    ...
    def __init__(self):
        ...
        self.corrections = {
            'address': -2.401371461920071,
            'alu': -4.226218266705558,
            'control': -0.6675663845929215,
            'data_transfer': 8.093813831339354,
            'decrypt': 3.197184126057775,
            'memory': -0.2082725415815697,
        }
