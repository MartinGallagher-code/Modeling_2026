#!/usr/bin/env python3
"""
Hitachi HD63484-2 ACRTC Grey-Box Queueing Model
===============================================
...
class Hd634842Model(BaseProcessorModel):
    """
    Hitachi HD63484-2 ACRTC Grey-Box Queueing Model

    Enhanced ACRTC, faster drawing commands (1987)
    - Enhanced ACRTC
    - Hardware drawing
    - Faster fill
    """

    name = "Hitachi HD63484-2 ACRTC"
    ...
    def __init__(self):
        self.instruction_categories = {
            ...
            'pixel': InstructionCategory('pixel', 3.0, 0, "Pixel operation"),
            ...
            'blit': InstructionCategory('blit', 3.0, 0, "Block transfer"),
        }
