# Hitachi H8/300H Model Changelog
...
**Session goal:** Create initial grey-box queueing model for Hitachi H8/300H
...
**What we learned:**
- Hitachi H8/300H (1992) is a 16-bit processor at 16.0 MHz
...
1. Updated measured_cpi.json with externally-validated benchmark data
  ...
  - mips_rating: 5.0 MIPS @ 16.0MHz → CPI=3.20
