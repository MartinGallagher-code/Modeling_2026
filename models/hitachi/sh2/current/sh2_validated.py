#!/usr/bin/env python3
"""
Hitachi SH-2 Grey-Box Queueing Model
====================================
...
class Sh2Model(BaseProcessorModel):
    """
    Hitachi SH-2 Grey-Box Queueing Model

    Dual SH-2 in Sega Saturn, 5-stage pipeline (1994)
    - 5-stage pipeline
    - Hardware multiply
    - Sega Saturn CPU
    """
    ...
    def __init__(self):
        ...
        self.corrections = {
            'alu': 0.5645022998843644,
            'branch': -0.7561065484603204,
            'divide': -5.153062306736914,
            'load': -0.9496375176667144,
            'multiply': -2.3591507901837305,
            'store': 1.775537693263103,
        }
