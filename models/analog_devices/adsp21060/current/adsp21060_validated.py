#!/usr/bin/env python3
"""
ADSP-21060 SHARC Grey-Box Queueing Model
========================================
...
class Adsp21060Model(BaseProcessorModel):
    """
    ADSP-21060 SHARC Grey-Box Queueing Model
    Target CPI: 1.0
    """

    name = "ADSP-21060 SHARC"
    manufacturer = "Analog Devices"
    year = 1994
    clock_mhz = 40.0
    transistor_count = 1500000
    data_width = 32
    address_width = 32
    ...
    def __init__(self):
        self.instruction_categories = {
            ...
            'load': InstructionCategory('load', 1.0, 0, "Data load (dual-port)"),
            'store': InstructionCategory('store', 1.0, 0, "Data store"),
            'branch': InstructionCategory('branch', 1.0, 0, "Branch/loop"),
            'special': InstructionCategory('special', 2.0, 0, "Link port/DMA"),
        }
