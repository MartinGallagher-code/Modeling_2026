#!/usr/bin/env python3
"""
Analog Devices ADSP-21020 Grey-Box Queueing Model
=================================================

Architecture: 32-bit floating-point SHARC predecessor
Year: 1990, Clock: 33.0 MHz
...
class Adsp21020Model(BaseProcessorModel):
    """
    Analog Devices ADSP-21020 Grey-Box Queueing Model

    32-bit floating-point SHARC predecessor (1990)
    - IEEE float
    - SHARC predecessor
    - Multi-function
    """

    name = "Analog Devices ADSP-21020"
