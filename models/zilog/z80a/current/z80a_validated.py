...
Features:
  - Higher speed version of Z80 (4 MHz vs 2.5 MHz)
  - Identical instruction timing (same T-states)
  - 8-bit data bus, 16-bit address bus
  - 4-23 cycles per instruction

Calibrated: 2026-01-28
Target CPI: ~5.5 for typical workloads (same as Z80)
Used in: MSX, Amstrad CPC, many arcade machines
"""
...
class Z80aModel(BaseProcessorModel):
    """
    Z80A Grey-Box Queueing Model

    Architecture: 8-bit NMOS microprocessor (1978)
    - Higher speed Z80 variant (4 MHz)
    - Identical instruction timing to Z80
    ...
    manufacturer = "Zilog"
    year = 1978
    clock_mhz = 4.0  # Higher than Z80's 2.5 MHz
