...
Features:
  - Highest speed version of Z80 (6 MHz)
...
class Z80bModel(BaseProcessorModel):
    """
    Z80B Grey-Box Queueing Model

    Architecture: 8-bit NMOS microprocessor (1978)
    - Highest speed Z80 variant (6 MHz)
    ...
    manufacturer = "Zilog"
    year = 1978
    clock_mhz = 6.0  # Highest Z80 variant
    transistor_count = 8500
    data_width = 8
    address_width = 16

    def __init__(self):
        # Same instruction timing as Z80
