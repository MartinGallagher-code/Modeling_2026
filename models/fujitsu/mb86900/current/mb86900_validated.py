...
class Mb86900Model(BaseProcessorModel):
    """
    Fujitsu MB86900 Grey-Box Queueing Model

    First silicon SPARC implementation, Sun-4 workstations (1986)
    - First SPARC silicon
    - Gate array
    - Register windows
    """
