# Fujitsu MB8845 Architectural Documentation
...
2. Key modeling considerations:
   ...
   - MB8841 variant with same core architecture as MB8842/MB8843 siblings
   - Differences from other MB884x variants are in pin configuration and I/O arrangement, not in instruction timing
...
- Cross-reference with MB884x family application notes
- Target: <5% IPC prediction error

## References

- [Original Datasheet](TODO: Add link)
- [WikiChip](https://en.wikichip.org/wiki/fujitsu/mb8845)
