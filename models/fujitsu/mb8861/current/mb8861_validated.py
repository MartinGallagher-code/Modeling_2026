...
Architecture: 8-bit microprocessor (1977)
Queueing Model: Sequential execution, cycle-accurate

Features:
  - 6800-compatible clone by Fujitsu
...
Target CPI: ~4.0 for typical workloads (same as 6800)
Used in: Japanese arcade machines, early Japanese computers
"""
...
class MB8861Model(BaseProcessorModel):
    """
    Fujitsu MB8861 Grey-Box Queueing Model

    Architecture: 8-bit NMOS microprocessor (1977)
    - 6800-compatible clone
    - Sequential execution (no pipeline)
    - Same instruction timing as Motorola 6800
    ...
    year = 1977
    clock_mhz = 1.0
    transistor_count = 4100  # Same as 6800
    data_width = 8
    address_width = 16

    def __init__(self):
        # MB8861 instruction timing identical to M6800
        # Fujitsu's clone maintains full timing compatibility
        #
        # Actual instruction timings (same as M6800):
        ...
        self.workload_profiles = {
            'typical': WorkloadProfile('typical', {
                ...
                'stack': 0.05,
                'call_return': 0.05,
            }, "Typical MB8861 workload (arcade games)"),
        ...
        self.corrections = {
            'alu': -1.510950,
            'call_return': 4.876810,
            'control': 0.623183,
            'data_transfer': 0.862643,
            'memory': 0.080190,
            'stack': -3.905776
        }
