# Fujitsu MB8842 Architectural Documentation
...
- Used in Namco arcade machines (Pac-Man era hardware)
...
2. Key modeling considerations:
   ...
   - MB8841 variant with larger ROM (2KB vs 1KB) but identical instruction timing
   - Harvard architecture provides separate program and data paths but execution remains sequential
   - Arcade application focus means controller/I/O workloads are primary use case
...
- Cross-reference with Namco Pac-Man era hardware documentation
- Target: <5% IPC prediction error

## References

- [Original Datasheet](TODO: Add link)
- [WikiChip](https://en.wikichip.org/wiki/fujitsu/mb8842)
