#!/usr/bin/env python3
"""
Fujitsu SPARClite Grey-Box Queueing Model
=========================================

Architecture: Embedded SPARC variant, no FPU, low power
Year: 1993, Clock: 50.0 MHz
...
class SparcliteModel(BaseProcessorModel):
    """
    Fujitsu SPARClite Grey-Box Queueing Model

    Embedded SPARC variant, no FPU, low power (1993)
    - SPARC V8 subset
    - No FPU
    - Integer-only
    """

    name = "Fujitsu SPARClite"
