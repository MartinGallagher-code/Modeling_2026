# Microchip PIC16C7x Model Changelog
...
**Session goal:** Create initial grey-box queueing model for Microchip PIC16C7x
...
**What we learned:**
- Microchip PIC16C7x (1992) is a 8-bit processor at 20.0 MHz
