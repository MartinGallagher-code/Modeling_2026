#!/usr/bin/env python3
"""
Yamaha YMF262 OPL3 Grey-Box Queueing Model
==========================================

Architecture: 4-operator FM, Sound Blaster 16 standard
Year: 1990, Clock: 14.32 MHz
...
class Ymf262Model(BaseProcessorModel):
    """
    Yamaha YMF262 OPL3 Grey-Box Queueing Model

    4-operator FM, Sound Blaster 16 standard (1990)
    - 36 channels
    - 4-operator FM
    - Stereo output
    """
    ...
    def __init__(self):
        self.instruction_categories = {
            ...
            'control': InstructionCategory('control', 2.0, 0, "Sequencing/control"),
