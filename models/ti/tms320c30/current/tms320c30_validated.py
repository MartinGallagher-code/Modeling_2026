...
class Tms320c30Model(BaseProcessorModel):
    """
    TI TMS320C30 Grey-Box Queueing Model

    First floating-point TMS320, audio and scientific (1988)
