...
class Tms320c25Model(BaseProcessorModel):
    """
    TI TMS320C25 Grey-Box Queueing Model

    100ns cycle, Harvard architecture, dominant in modems (1986)
