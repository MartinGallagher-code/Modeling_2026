#!/usr/bin/env python3
"""
TI TMS320C54x Grey-Box Queueing Model
=====================================

Low-power fixed-point DSP, mobile telephony
Year: 1995, Clock: 50.0 MHz
...
class Tms320c54xModel(BaseProcessorModel):
    """
    TI TMS320C54x Grey-Box Queueing Model
    Target CPI: 1.0
    """
    ...
    year = 1995
    clock_mhz = 50.0
    transistor_count = 800000
    data_width = 16
    address_width = 24

    def __init__(self):
        self.instruction_categories = {
            'mac': InstructionCategory('mac', 1.0, 0, "MAC single-cycle"),
            ...
            'special': InstructionCategory('special', 1.0, 0, "Bit-reverse/circular"),
        }
