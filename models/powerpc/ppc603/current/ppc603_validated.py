...
class Ppc603Model(BaseProcessorModel):
    """
    PowerPC 603 Grey-Box Queueing Model

    Low-power PowerPC, 5-stage pipeline, PowerBook 5300 (1993)
    - 5-stage pipeline
    - 8KB I+D cache
    - Low power
    """
    ...
    def __init__(self):
        self.instruction_categories = {
            ...
            'divide': InstructionCategory('divide', 19.0, 0, "Divide"),
        }
        ...
        self.corrections = {
            'alu': 1.0392315456764747,
            'branch': 0.1431933084928679,
            'divide': -13.37661550558911,
            'load': -5.07206052164975,
            'multiply': -6.336997877425154,
            'store': 2.5442644944109,
        }
