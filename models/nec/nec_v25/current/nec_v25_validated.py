#!/usr/bin/env python3
"""
NEC V25 Grey-Box Queueing Model
===============================

Enhanced V20 with on-chip peripherals, 8086 compatible
...
class NecV25Model(BaseProcessorModel):
    """
    NEC V25 Grey-Box Queueing Model
    Target CPI: 3.5
    """
    ...
    def __init__(self):
        self.instruction_categories = {
            ...
            'data_transfer': InstructionCategory('data_transfer', 2.5, 0, "MOV/PUSH/POP"),
            ...
            'divide': InstructionCategory('divide', 30.0, 0, "DIV"),
        }
