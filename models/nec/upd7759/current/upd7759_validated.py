#!/usr/bin/env python3
"""
NEC uPD7759 Grey-Box Queueing Model
===================================

Architecture: ADPCM voice synthesis for arcade games
Year: 1987, Clock: 5.0 MHz
...
class Upd7759Model(BaseProcessorModel):
    """
    NEC uPD7759 Grey-Box Queueing Model

    ADPCM voice synthesis for arcade games (1987)
    - ADPCM decoding
    - Speech synthesis
    - Arcade standard
    """
    ...
    def __init__(self):
        self.instruction_categories = {
            'oscillator': InstructionCategory('oscillator', 3.0, 0, "Waveform generation"),
