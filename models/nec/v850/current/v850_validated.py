#!/usr/bin/env python3
"""
NEC V850 Grey-Box Queueing Model
================================
...
class V850Model(BaseProcessorModel):
    """
    NEC V850 Grey-Box Queueing Model

    Embedded RISC for automotive ECUs (1994)
    - 5-stage pipeline
    - On-chip ROM/RAM
    - Automotive grade
    """
    ...
    def __init__(self):
        ...
        self.corrections = {
            'alu': 0.7701057861150371,
            'branch': 0.3214927120362034,
            'divide': -6.435441917569629,
            'load': -2.6486530472397103,
            'multiply': -2.9215726583579578,
            'store': 1.164558082430368,
        }
