#!/usr/bin/env python3
"""
Sun MicroSPARC II Grey-Box Queueing Model
=========================================

Architecture: Enhanced MicroSPARC, SPARCstation 5
Year: 1994, Clock: 110.0 MHz
...
class MicrosparcIiModel(BaseProcessorModel):
    """
    Sun MicroSPARC II Grey-Box Queueing Model

    Enhanced MicroSPARC, SPARCstation 5 (1994)
    - Enhanced pipeline
    - 8KB I+D caches
    - Integrated FPU
    """

    name = "Sun MicroSPARC II"
    manufacturer = "Sun"
    year = 1994
    clock_mhz = 110.0
    ...
    def __init__(self):
        ...
        self.corrections = {
            'alu': 0.609892961215364,
            'branch': -0.7657347248881008,
            'divide': -10.887614575127872,
            'load': -3.2405449775936455,
            'multiply': -4.643865483530304,
            'store': -0.04772248783263356,
        }
