#!/usr/bin/env python3
"""
Sun SuperSPARC Grey-Box Queueing Model
======================================
...
class SupersparcModel(BaseProcessorModel):
    """
    Sun SuperSPARC Grey-Box Queueing Model

    3-issue superscalar SPARC, SPARCstation 10/20 (1992)
    - 3-issue superscalar
    - 20KB I-cache
    - 16KB D-cache
    """
    ...
    def __init__(self):
        ...
        self.corrections = {
            'alu': 0.19714556130189292,
            'branch': -0.28627078973430137,
            'divide': -8.121920654675668,
            'load': -2.741442973699178,
            'multiply': -4.999746659544092,
            'store': 1.992070275719198,
        }
