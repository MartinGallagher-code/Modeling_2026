#!/usr/bin/env python3
"""
Sun UltraSPARC I Grey-Box Queueing Model
========================================

Architecture: 64-bit SPARC V9, VIS multimedia instructions
Year: 1995, Clock: 167.0 MHz
...
class UltrasparcIModel(BaseProcessorModel):
    """
    Sun UltraSPARC I Grey-Box Queueing Model

    64-bit SPARC V9, VIS multimedia instructions (1995)
    - 4-issue superscalar
    - 64-bit SPARC V9
    - VIS SIMD
    """

    name = "Sun UltraSPARC I"
    manufacturer = "Sun/TI"
    year = 1995
    clock_mhz = 167.0
    transistor_count = 5200000
    data_width = 64
    address_width = 64
