#!/usr/bin/env python3
"""
Sega SVP (SSP1601) Grey-Box Queueing Model
==========================================

Architecture: DSP in Virtua Racing cartridge
Year: 1994, Clock: 23.0 MHz
...
class SegaSvpModel(BaseProcessorModel):
    """
    Sega SVP (SSP1601) Grey-Box Queueing Model

    DSP in Virtua Racing cartridge (1994)
    - Samsung SSP1601
    - 16-bit DSP
    - In-cartridge
    """

    name = "Sega SVP (SSP1601)"
