#!/usr/bin/env python3
"""
MIPS R4600 Orion Grey-Box Queueing Model
========================================
...
class MipsR4600Model(BaseProcessorModel):
    """
    MIPS R4600 Orion Grey-Box Queueing Model

    Low-cost R4000 derivative, Cisco routers (1994)
    - 5-stage pipeline
    - 64-bit
    - Low-cost design
    """

    name = "MIPS R4600 Orion"
    manufacturer = "QED/IDT"
    year = 1994
    clock_mhz = 133.0
    transistor_count = 1900000
    data_width = 64
    address_width = 64
    ...
    def __init__(self):
        ...
        self.corrections = {
            'alu': 0.6590991179450949,
            'branch': -0.7761725401701731,
            'divide': -8.599814249593852,
            'load': -2.3186166435736024,
            'multiply': -4.952530830746495,
            'store': 1.3811924504061595,
        }
