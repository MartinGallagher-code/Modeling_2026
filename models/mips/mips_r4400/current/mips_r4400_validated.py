...
class MipsR4400Model(BaseProcessorModel):
    """
    MIPS R4400 Grey-Box Queueing Model

    Improved R4000 with larger caches, SGI Indy/Indigo2 (1993)
    ...
    def __init__(self):
        self.instruction_categories = {
            ...
            'multiply': InstructionCategory('multiply', 5.0, 0, "Multiply"),
            'divide': InstructionCategory('divide', 14.0, 0, "Divide"),
        }
        ...
        self.corrections = {
            'alu': 0.8032958327979799,
            'branch': -1.6855476008965429,
            'divide': -10.241330432423952,
            'load': -2.8812996188273616,
            'multiply': -6.129764769369134,
            'store': 1.2738695675760618,
        }
