#!/usr/bin/env python3
"""
SGI R10000 Grey-Box Queueing Model
==================================

Architecture: Out-of-order MIPS, register renaming
Year: 1994, Clock: 200.0 MHz
...
class MipsR10000Model(BaseProcessorModel):
    """
    SGI R10000 Grey-Box Queueing Model

    Out-of-order MIPS, register renaming (1994)
    ...
    def __init__(self):
        ...
        self.corrections = {
            'alu': -0.11528226807786088,
            'branch': -0.46039467040772714,
            'divide': -5.734832658758416,
            'load': -2.570558128562255,
            'multiply': -3.1859566820570464,
            'store': 0.36289729124160197,
        }
