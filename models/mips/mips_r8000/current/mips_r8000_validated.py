...
class MipsR8000Model(BaseProcessorModel):
    """
    MIPS R8000 Grey-Box Queueing Model

    First superscalar MIPS, 4-way FP, scientific workloads (1994)
    - Superscalar
    - 4-way FP
    - Out-of-order FP
    """
    ...
    def __init__(self):
        ...
        self.corrections = {
            'alu': 0.47789219541564903,
            'branch': -0.8589468293305942,
            'divide': -5.174751705599375,
            'load': -2.2189303359424346,
            'multiply': -2.5431419530618014,
            'store': 0.6442013744006105,
        }
