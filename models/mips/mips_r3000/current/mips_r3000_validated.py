#!/usr/bin/env python3
"""
MIPS R3000 Grey-Box Queueing Model
==================================
...
class MipsR3000Model(BaseProcessorModel):
    """
    MIPS R3000 Grey-Box Queueing Model

    32-bit RISC, 5-stage pipeline, SGI/DECstation, PS1 variant (1988)
    - 5-stage pipeline
    - 32-bit RISC
    - No on-chip cache
    """
    ...
    def __init__(self):
        ...
        self.corrections = {
            'alu': 0.7824363026466389,
            'branch': -0.681138770232473,
            'divide': -8.360903968475892,
            'load': -2.3119590087088353,
            'multiply': -4.999999456918966,
            'store': 1.6292546271861141,
        }
