...
class MipsR4000Model(BaseProcessorModel):
    """
    MIPS R4000 Grey-Box Queueing Model

    First commercial 64-bit RISC, 8-stage superpipeline (1991)
    ...
    def __init__(self):
        ...
        self.corrections = {
            'alu': 0.9422286055214368,
            'branch': -1.593806067837882,
            'divide': -10.913632701041307,
            'load': -2.478210864595485,
            'multiply': -6.27397943463446,
            'store': 2.0780838589587005,
        }
