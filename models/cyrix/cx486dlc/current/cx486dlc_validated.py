#!/usr/bin/env python3
"""
Cyrix Cx486DLC Grey-Box Queueing Model
======================================

Architecture: 486 ISA in 386 pin-out, 1KB cache
Year: 1992, Clock: 33.0 MHz
...
class Cx486dlcModel(BaseProcessorModel):
    """
    Cyrix Cx486DLC Grey-Box Queueing Model

    486 ISA in 386 pin-out, 1KB cache (1992)
    - 386 pin-compatible
    - 1KB cache
    - 486 instruction set
    """
