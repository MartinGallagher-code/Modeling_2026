#!/usr/bin/env python3
"""
Cyrix Cx486SLC Grey-Box Queueing Model
======================================

Architecture: 486 ISA for 386SX systems, 16-bit bus
Year: 1992, Clock: 25.0 MHz
...
class Cx486slcModel(BaseProcessorModel):
    """
    Cyrix Cx486SLC Grey-Box Queueing Model

    486 ISA for 386SX systems, 16-bit bus (1992)
    ...
    def __init__(self):
        self.instruction_categories = {
            'alu': InstructionCategory('alu', 1.5, 0, "ALU/logic"),
            'data_transfer': InstructionCategory('data_transfer', 1.5, 0, "Register transfer"),
        ...
        self.corrections = {
            'alu': 1.4103723848532337,
            'control': -2.0896276151467696,
            'data_transfer': 1.4103723848532301,
            'divide': -9.164104585792876,
            'memory': -1.0966276151467684,
            'multiply': -18.052389129823762,
        }
