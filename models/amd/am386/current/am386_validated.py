#!/usr/bin/env python3
"""
AMD Am386 Grey-Box Queueing Model
=================================
...
class Am386Model(BaseProcessorModel):
    """
    AMD Am386 Grey-Box Queueing Model

    AMD's 386 clone, 40 MHz (faster than Intel's 33 MHz) (1991)
    - 386-compatible
    - 40 MHz
    - No on-chip cache
    """
    ...
    def __init__(self):
        self.instruction_categories = {
            ...
            'divide': InstructionCategory('divide', 38.0, 0, "Divide"),
        }
