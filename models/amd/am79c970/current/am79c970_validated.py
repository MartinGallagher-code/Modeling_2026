#!/usr/bin/env python3
"""
AMD Am79C970 PCnet Grey-Box Queueing Model
==========================================

Architecture: Ethernet controller with on-chip processor
Year: 1993, Clock: 20.0 MHz
...
class Am79c970Model(BaseProcessorModel):
    """
    AMD Am79C970 PCnet Grey-Box Queueing Model

    Ethernet controller with on-chip processor (1993)
    - Ethernet controller
    - 10 Mbps
    - PCI/ISA
    """

    name = "AMD Am79C970 PCnet"
    manufacturer = "AMD"
    year = 1993
    clock_mhz = 20.0
