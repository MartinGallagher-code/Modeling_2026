...
class Am486Model(BaseProcessorModel):
    ...
    def __init__(self):
        ...
        self.corrections = {
            'alu': 0.7362484515949224,
            'control': -1.238541332857,
            'data_transfer': 0.8121015298058584,
            'divide': -18.808343287466204,
            'memory': -0.508496301516403,
            'multiply': -12.999998674016062,
        }
