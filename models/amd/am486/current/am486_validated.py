#!/usr/bin/env python3
"""
AMD Am486 Grey-Box Queueing Model
=================================

Architecture: AMD's 486 clone with write-back cache
Year: 1993, Clock: 40.0 MHz
...
class Am486Model(BaseProcessorModel):
    """
    AMD Am486 Grey-Box Queueing Model

    AMD's 486 clone with write-back cache (1993)
    - 486-compatible
    - Write-back cache
    - 5-stage pipeline
    """
    ...
    def __init__(self):
        ...
        self.corrections = {
            'alu': 0.7300180982210976,
            'control': -1.2699819017788998,
            'data_transfer': 0.7300180982210961,
            'divide': -9.273601545998446,
            'memory': -0.5513819017789013,
            'multiply': -18.268172079669117,
        }
