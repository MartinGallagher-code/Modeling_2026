...
class Arm3Model(BaseProcessorModel):
    """
    ARM3 - First ARM with Cache
    Target CPI: 1.4
    """
    ...
    def __init__(self):
        # ARM3: Cache makes it faster, calibrated for CPI 1.33
        # 0.52*1.0 + 0.20*1.7 + 0.12*1.3 + 0.16*1.7 = 0.52 + 0.34 + 0.156 + 0.272 = 1.288
