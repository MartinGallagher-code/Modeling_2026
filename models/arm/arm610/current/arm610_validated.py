#!/usr/bin/env python3
"""
ARM610 Grey-Box Queueing Model
==============================
...
class Arm610Model(BaseProcessorModel):
    """
    ARM610 Grey-Box Queueing Model

    First ARM6 variant, Acorn RiscPC, Apple Newton (1993)
    - 3-stage pipeline
    - 4KB cache
    - 32-bit address
    """
    ...
    def __init__(self):
        self.instruction_categories = {
            ...
            'divide': InstructionCategory('divide', 16.0, 0, "Divide"),
        }
        ...
        self.corrections = {
            'alu': 0.7384116475202389,
            'branch': -1.5500443294656066,
            'divide': -13.06620718096104,
            'load': -1.6361773175398713,
            'multiply': -4.999407348664558,
            'store': 0.9821536279590033,
        }
