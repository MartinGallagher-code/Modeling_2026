#!/usr/bin/env python3
"""
ARM7TDMI Grey-Box Queueing Model
================================
...
class Arm7tdmiModel(BaseProcessorModel):
    """
    ARM7TDMI Grey-Box Queueing Model

    Thumb mode, hardware debug, dominant embedded core (1994)
    - 3-stage pipeline
    - Thumb 16-bit mode
    - Hardware debug
    """
    ...
    def __init__(self):
        ...
        self.corrections = {
            'alu': 0.8555966122746177,
            'branch': -1.5754295844218906,
            'divide': -8.420298600939379,
            'load': -2.184121272859651,
            'multiply': -4.730560567904413,
            'store': 1.4796013990606327,
        }
