...
class Arm250Model(BaseProcessorModel):
    """
    ARM250 Grey-Box Queueing Model

    ARM2 with MMU, MEMC, VIDC integrated, Acorn A3000 (1990)
    - ARM2 core
    ...
    def __init__(self):
        self.instruction_categories = {
            ...
            'multiply': InstructionCategory('multiply', 8.0, 0, "Multiply"),
