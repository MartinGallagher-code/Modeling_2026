#!/usr/bin/env python3
"""
INMOS T9000 Grey-Box Queueing Model
===================================

Superscalar transputer, virtual channels, grouping scheduler
...
class T9000Model(BaseProcessorModel):
    """
    INMOS T9000 Grey-Box Queueing Model
    Target CPI: 1.0
    """
    ...
    def __init__(self):
        self.instruction_categories = {
            ...
            'branch': InstructionCategory('branch', 1.0, 0, "Branch"),
            'channel': InstructionCategory('channel', 2.0, 0, "Channel communication"),
            'fp': InstructionCategory('fp', 1.0, 0, "FP ops (pipelined)"),
        }

        self.workload_profiles = {
            'typical': WorkloadProfile('typical', {'alu': 0.15, 'load': 0.17, 'store': 0.17, 'branch': 0.17, 'channel': 0.17, 'fp': 0.17}, "Typical workload"),
            'compute': WorkloadProfile('compute', {'alu': 0.3, 'load': 0.14, 'store': 0.14, 'branch': 0.14, 'channel': 0.14, 'fp': 0.14}, "Compute workload"),
            'memory': WorkloadProfile('memory', {'alu': 0.12, 'load': 0.14, 'store': 0.14, 'branch': 0.32, 'channel': 0.14, 'fp': 0.14}, "Memory workload"),
            'control': WorkloadProfile('control', {'alu': 0.12, 'load': 0.14, 'store': 0.14, 'branch': 0.14, 'channel': 0.32, 'fp': 0.14}, "Control workload"),
            'mixed': WorkloadProfile('mixed', {'alu': 0.12, 'load': 0.32, 'store': 0.14, 'branch': 0.14, 'channel': 0.14, 'fp': 0.14}, "Mixed workload"),
        }
