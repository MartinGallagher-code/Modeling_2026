#!/usr/bin/env python3
"""
Data General mN602 Grey-Box Queueing Model
=============================================
...
class Mn602Model(BaseProcessorModel):
    """Data General mN602 - Enhanced microNova, DG minicomputer lineage"""

    name = "Data General mN602"
    ...
    def __init__(self):
        self.instruction_categories = {
            'alu': InstructionCategory('alu', 3.5, 0, "Acc ALU @3-4c"),
            'data_transfer': InstructionCategory('data_transfer', 3.5, 0, "Reg/mem @3-4c"),
            'memory': InstructionCategory('memory', 6.0, 0, "Memory @5-8c"),
            'control': InstructionCategory('control', 7.0, 0, "Branch/JSR @5-10c"),
