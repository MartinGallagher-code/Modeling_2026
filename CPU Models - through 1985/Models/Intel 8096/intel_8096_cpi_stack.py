...
class CPIStackResult:
    ...
    def compute_totals(self):
        self.cpi_total = self.cpi_base+ self.cpi_prefetch + self.cpi_memory
...
class Intel8096CPIStackModel:
    """
    CPI Stack Model for Intel 8096.
...
def main():
    model = Intel8096CPIStackModel()
    
    print("\n" + "="*55)
    print("Intel 8096 CPI STACK MODEL")
    print("="*55)
