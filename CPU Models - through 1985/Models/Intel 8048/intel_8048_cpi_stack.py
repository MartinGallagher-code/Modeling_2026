...
class Intel8048CPIStackModel:
    """
    CPI Stack Model for Intel 8048.
...
def main():
    model = Intel8048CPIStackModel()
    
    print("\n" + "="*55)
    print("Intel 8048 CPI STACK MODEL")
    print("="*55)
