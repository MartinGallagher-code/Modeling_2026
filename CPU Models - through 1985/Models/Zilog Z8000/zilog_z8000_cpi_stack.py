...
class ZilogZ8000CPIStackModel:
    """
    CPI Stack Model for Zilog Z8000.
...
def main():
    model = ZilogZ8000CPIStackModel()
    
    print("\n" + "="*55)
    print("Zilog Z8000 CPI STACK MODEL")
    print("="*55)
