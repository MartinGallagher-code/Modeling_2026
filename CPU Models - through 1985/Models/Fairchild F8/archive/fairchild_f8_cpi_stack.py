...
class FairchildF8CPIStackModel:
    """
    CPI Stack Model for Fairchild F8.
    ...
    def print_result(self, result: CPIStackResult):
        ...
        print(f"\n{'='*55}")
        print(f"CPI STACK: Fairchild F8")
        print(f"{'='*55}")
...
def main():
    model = FairchildF8CPIStackModel()
    
    print("\n" + "="*55)
    print("Fairchild F8 CPI STACK MODEL")
    print("="*55)
