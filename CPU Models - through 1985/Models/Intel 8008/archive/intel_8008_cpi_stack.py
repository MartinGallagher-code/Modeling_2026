...
class Intel8008CPIStackModel:
    """
    CPI Stack Model for Intel 8008.
...
def main():
    model = Intel8008CPIStackModel()
    
    print("\n" + "="*55)
    print("Intel 8008 CPI STACK MODEL")
    print("="*55)
