#!/usr/bin/env python3
"""
Ferranti f1001 CPI Stack Model
...
class FerrantiF1001CPIStackModel:
    """
    CPI Stack Model for Ferranti f1001.
    ...
    def print_result(self, result: CPIStackResult):
        ...
        print(f"\n{'='*55}")
        print(f"CPI STACK: Ferranti f1001")
        print(f"{'='*55}")
...
def main():
    model = FerrantiF1001CPIStackModel()
    
    print("\n" + "="*55)
    print("Ferranti f1001 CPI STACK MODEL")
    print("="*55)
