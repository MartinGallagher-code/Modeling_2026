...
class ZilogZ80CPIStackModel:
    """
    CPI Stack Model for Zilog Z80.
...
def main():
    model = ZilogZ80CPIStackModel()
    
    print("\n" + "="*55)
    print("Zilog Z80 CPI STACK MODEL")
    print("="*55)
