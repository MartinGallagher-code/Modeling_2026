...
class Intel8085CPIStackModel:
    """
    CPI Stack Model for Intel 8085.
...
def main():
    model = Intel8085CPIStackModel()
    
    print("\n" + "="*55)
    print("Intel 8085 CPI STACK MODEL")
    print("="*55)
