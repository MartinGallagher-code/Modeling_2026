...
class RcaCdp1804CPIStackModel:
    """
    CPI Stack Model for RCA CDP1804.
...
def main():
    model = RcaCdp1804CPIStackModel()
    
    print("\n" + "="*55)
    print("RCA CDP1804 CPI STACK MODEL")
    print("="*55)
