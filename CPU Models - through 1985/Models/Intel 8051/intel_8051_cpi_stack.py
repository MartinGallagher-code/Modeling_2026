...
class Intel8051CPIStackModel:
    """
    CPI Stack Model for Intel 8051.
...
def main():
    model = Intel8051CPIStackModel()
    
    print("\n" + "="*55)
    print("Intel 8051 CPI STACK MODEL")
    print("="*55)
