...
class MipsR2000CPIStackModel:
    """
    CPI Stack Model for MIPS R2000.
    ...
    def predict(self, workload: Workload = None) -> CPIStackResult:
        ...
        result.cpi_pipeline = result.cpi_base * 0.02 * (5 - 2)
...
def main():
    model = MipsR2000CPIStackModel()
    
    print("\n" + "="*55)
    print("MIPS R2000 CPI STACK MODEL")
    print("="*55)
