...
class Amd2901CPIStackModel:
    """
    CPI Stack Model for AMD 2901.
...
def main():
    model = Amd2901CPIStackModel()
    
    print("\n" + "="*55)
    print("AMD 2901 CPI STACK MODEL")
    print("="*55)
