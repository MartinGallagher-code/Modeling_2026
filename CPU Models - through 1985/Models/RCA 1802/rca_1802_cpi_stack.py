...
class Rca1802CPIStackModel:
    """
    CPI Stack Model for RCA 1802.
...
def main():
    model = Rca1802CPIStackModel()
    
    print("\n" + "="*55)
    print("RCA 1802 CPI STACK MODEL")
    print("="*55)
