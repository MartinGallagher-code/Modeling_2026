#!/usr/bin/env python3
"""
Intel 4040 Validated Performance Model

Enhanced 4004 with interrupts
...
@dataclass
class I4040Specs:
    """Validated Intel 4040 specifications."""
    name: str = "Intel 4040"
    year: int = 1974
    manufacturer: str = "Various"
    data_width: int = 4
    clock_mhz: float = 0.74
    transistors: int = 3000
    technology: str = "10µm PMOS"
    package: str = "24-pin DIP"
...
class I4040Model:
    """
    Validated performance model for Intel 4040.
    
    Uses grey-box queueing methodology with category-based timing.
    """
    
    def __init__(self):
        self.specs = I4040Specs()
        self.workloads = {
            'typical': I4040Workload('typical', 0.3, 0.5, 0.2),
            'compute': I4040Workload('compute', 0.5, 0.4, 0.1),
            'control': I4040Workload('control', 0.2, 0.4, 0.4),
        }
    
    def analyze(self, workload: str = 'typical',
                clock_mhz: float = 0.74) -> I4040Result:
