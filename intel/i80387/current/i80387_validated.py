#!/usr/bin/env python3
"""
Intel 80387 Validated Performance Model

FPU coprocessor for 80386
...
@dataclass
class I80387Specs:
    """Validated Intel 80387 specifications."""
    name: str = "Intel 80387"
    year: int = 1987
    manufacturer: str = "Various"
    data_width: int = 80
    clock_mhz: float = 16.0
    transistors: int = 104000
    technology: str = "CMOS"
...
class I80387Model:
    """
    Validated performance model for Intel 80387.
    
    Uses grey-box queueing methodology with category-based timing.
    """
    
    def __init__(self):
        self.specs = I80387Specs()
        self.workloads = {
            'typical': I80387Workload('typical', 0.3, 0.5, 0.2),
            'compute': I80387Workload('compute', 0.5, 0.4, 0.1),
            'control': I80387Workload('control', 0.2, 0.4, 0.4),
        }
    
    def analyze(self, workload: str = 'typical',
                clock_mhz: float = 16.0) -> I80387Result:
