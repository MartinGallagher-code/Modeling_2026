#!/usr/bin/env python3
"""
Intel 80286 Validated Performance Model

Protected mode, IBM PC/AT CPU
...
@dataclass
class I80286Specs:
    """Validated Intel 80286 specifications."""
    name: str = "Intel 80286"
    year: int = 1982
    manufacturer: str = "Various"
    data_width: int = 16
    clock_mhz: float = 8.0
    transistors: int = 134000
    technology: str = "1.5µm CMOS"
    package: str = "68-pin LCC"
    typical_cpi: float = 4.8


@dataclass
class I80286Workload:
    """Workload profile."""
    name: str
...
class I80286Model:
    """
    Validated performance model for Intel 80286.
    
    Uses grey-box queueing methodology with category-based timing.
    """
    
    def __init__(self):
        self.specs = I80286Specs()
        self.workloads = {
            'typical': I80286Workload('typical', 0.3, 0.5, 0.2),
            'compute': I80286Workload('compute', 0.5, 0.4, 0.1),
            'control': I80286Workload('control', 0.2, 0.4, 0.4),
        }
    
    def analyze(self, workload: str = 'typical',
                clock_mhz: float = 8.0) -> I80286Result:
    ...
    def validate(self) -> Dict:
        ...
        ips_min, ips_max = (1500000, 2500000)
        ...
        return {
            ...
            'cpi': {
                'expected': 4.8,
                'actual': result.cpi,
                'pass': abs(result.cpi - 4.8) < 4.8 * 0.3
            }
        }
