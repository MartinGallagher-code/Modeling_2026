#!/usr/bin/env python3
"""
Intel 80386 Validated Performance Model

First x86 32-bit processor
...
@dataclass
class I80386Specs:
    """Validated Intel 80386 specifications."""
    name: str = "Intel 80386"
    year: int = 1985
    manufacturer: str = "Various"
    data_width: int = 32
    clock_mhz: float = 16.0
    transistors: int = 275000
    technology: str = "1.5µm CMOS"
    package: str = "132-pin PGA"
    typical_cpi: float = 4.4


@dataclass
class I80386Workload:
    """Workload profile."""
    name: str
...
class I80386Model:
    """
    Validated performance model for Intel 80386.
    
    Uses grey-box queueing methodology with category-based timing.
    """
    
    def __init__(self):
        self.specs = I80386Specs()
        self.workloads = {
            'typical': I80386Workload('typical', 0.3, 0.5, 0.2),
            'compute': I80386Workload('compute', 0.5, 0.4, 0.1),
            'control': I80386Workload('control', 0.2, 0.4, 0.4),
        }
    
    def analyze(self, workload: str = 'typical',
                clock_mhz: float = 16.0) -> I80386Result:
    ...
    def validate(self) -> Dict:
        ...
        ips_min, ips_max = (3000000, 6000000)
        ...
        return {
            ...
            'cpi': {
                'expected': 4.4,
                'actual': result.cpi,
                'pass': abs(result.cpi - 4.4) < 4.4 * 0.3
            }
        }
