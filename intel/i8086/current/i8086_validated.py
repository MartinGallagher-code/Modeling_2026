#!/usr/bin/env python3
"""
Intel 8086 Validated Performance Model
...
@dataclass
class I8086Specs:
    """Validated Intel 8086 specifications."""
    name: str = "Intel 8086"
    year: int = 1978
...
class I8086Model:
    """
    Validated performance model for Intel 8086.
    
    Uses grey-box queueing methodology with category-based timing.
    """
    
    def __init__(self):
        self.specs = I8086Specs()
        self.workloads = {
            'typical': I8086Workload('typical', 0.3, 0.5, 0.2),
            'compute': I8086Workload('compute', 0.5, 0.4, 0.1),
            'control': I8086Workload('control', 0.2, 0.4, 0.4),
        }
    
    def analyze(self, workload: str = 'typical',
                clock_mhz: float = 5.0) -> I8086Result:
