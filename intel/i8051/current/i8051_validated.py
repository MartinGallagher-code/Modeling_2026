#!/usr/bin/env python3
"""
Intel 8051 Validated Performance Model

Most successful microcontroller family
...
@dataclass
class I8051Specs:
    """Validated Intel 8051 specifications."""
    name: str = "Intel 8051"
    year: int = 1980
...
class I8051Model:
    """
    Validated performance model for Intel 8051.
    
    Uses grey-box queueing methodology with category-based timing.
    """
    
    def __init__(self):
        self.specs = I8051Specs()
        self.workloads = {
            'typical': I8051Workload('typical', 0.3, 0.5, 0.2),
            'compute': I8051Workload('compute', 0.5, 0.4, 0.1),
            'control': I8051Workload('control', 0.2, 0.4, 0.4),
        }
    
    def analyze(self, workload: str = 'typical',
                clock_mhz: float = 12.0) -> I8051Result:
