...
class Intel8039CPIStackModel:
    """
    CPI Stack Model for Intel 8039.
...
def main():
    model = Intel8039CPIStackModel()
    
    print("\n" + "="*55)
    print("Intel 8039 CPI STACK MODEL")
    print("="*55)
