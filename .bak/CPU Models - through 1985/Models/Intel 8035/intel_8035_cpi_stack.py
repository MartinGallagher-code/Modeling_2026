...
class Intel8035CPIStackModel:
    """
    CPI Stack Model for Intel 8035.
...
def main():
    model = Intel8035CPIStackModel()
    
    print("\n" + "="*55)
    print("Intel 8035 CPI STACK MODEL")
    print("="*55)
