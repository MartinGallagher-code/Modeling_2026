...
class Wdc65c02CPIStackModel:
    """
    CPI Stack Model for WDC 65c02.
...
def main():
    model = Wdc65c02CPIStackModel()
    
    print("\n" + "="*55)
    print("WDC 65c02 CPI STACK MODEL")
    print("="*55)
