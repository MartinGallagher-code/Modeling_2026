...
class NecV30CPIStackModel:
    """
    CPI Stack Model for NEC V30.
...
def main():
    model = NecV30CPIStackModel()
    
    print("\n" + "="*55)
    print("NEC V30 CPI STACK MODEL")
    print("="*55)
