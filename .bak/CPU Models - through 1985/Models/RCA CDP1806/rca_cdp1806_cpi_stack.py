...
class RcaCdp1806CPIStackModel:
    """
    CPI Stack Model for RCA CDP1806.
...
def main():
    model = RcaCdp1806CPIStackModel()
    
    print("\n" + "="*55)
    print("RCA CDP1806 CPI STACK MODEL")
    print("="*55)
