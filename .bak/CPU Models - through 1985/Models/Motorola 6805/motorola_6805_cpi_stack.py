...
class Motorola6805CPIStackModel:
    """
    CPI Stack Model for Motorola 6805.
    ...
    def print_result(self, result: CPIStackResult):
        ...
        print(f"\n{'='*55}")
        print(f"CPI STACK: Motorola 6805")
        print(f"{'='*55}")
...
def main():
    model = Motorola6805CPIStackModel()
    
    print("\n" + "="*55)
    print("Motorola 6805 CPI STACK MODEL")
    print("="*55)
