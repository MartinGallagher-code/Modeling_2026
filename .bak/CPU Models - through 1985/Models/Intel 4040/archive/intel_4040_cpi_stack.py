...
class Intel4040CPIStackModel:
    """
    CPI Stack Model for Intel 4040.
...
def main():
    model = Intel4040CPIStackModel()
    
    print("\n" + "="*55)
    print("Intel 4040 CPI STACK MODEL")
    print("="*55)
