...
class Intel8085aCPIStackModel:
    """
    CPI Stack Model for Intel 8085a.
...
def main():
    model = Intel8085aCPIStackModel()
    
    print("\n" + "="*55)
    print("Intel 8085a CPI STACK MODEL")
    print("="*55)
