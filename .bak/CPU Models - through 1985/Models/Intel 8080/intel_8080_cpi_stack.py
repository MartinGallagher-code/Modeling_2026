...
class Intel8080CPIStackModel:
    """
    CPI Stack Model for Intel 8080.
...
def main():
    model = Intel8080CPIStackModel()
    
    print("\n" + "="*55)
    print("Intel 8080 CPI STACK MODEL")
    print("="*55)
