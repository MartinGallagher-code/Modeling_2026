...
class ZilogZ180CPIStackModel:
    """
    CPI Stack Model for Zilog Z180.
...
def main():
    model = ZilogZ180CPIStackModel()
    
    print("\n" + "="*55)
    print("Zilog Z180 CPI STACK MODEL")
    print("="*55)
