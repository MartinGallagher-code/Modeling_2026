...
class NscNsc800CPIStackModel:
    """
    CPI Stack Model for NSC NSC800.
...
def main():
    model = NscNsc800CPIStackModel()
    
    print("\n" + "="*55)
    print("NSC NSC800 CPI STACK MODEL")
    print("="*55)
