...
class ZilogZ8CPIStackModel:
    """
    CPI Stack Model for Zilog Z8.
...
def main():
    model = ZilogZ8CPIStackModel()
    
    print("\n" + "="*55)
    print("Zilog Z8 CPI STACK MODEL")
    print("="*55)
