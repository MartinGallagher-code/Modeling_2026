...
class Motorola6802CPIStackModel:
    """
    CPI Stack Model for Motorola 6802.
    ...
    def print_result(self, result: CPIStackResult):
        ...
        print(f"\n{'='*55}")
        print(f"CPI STACK: Motorola 6802")
        print(f"{'='*55}")
...
def main():
    model = Motorola6802CPIStackModel()
    
    print("\n" + "="*55)
    print("Motorola 6802 CPI STACK MODEL")
    print("="*55)
