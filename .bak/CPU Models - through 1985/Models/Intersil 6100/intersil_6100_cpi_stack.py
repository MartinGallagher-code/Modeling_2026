...
class Intersil6100CPIStackModel:
    """
    CPI Stack Model for Intersil 6100.
    ...
    def print_result(self, result: CPIStackResult):
        ...
        print(f"\n{'='*55}")
        print(f"CPI STACK: Intersil 6100")
        print(f"{'='*55}")
...
def main():
    model = Intersil6100CPIStackModel()
    
    print("\n" + "="*55)
    print("Intersil 6100 CPI STACK MODEL")
    print("="*55)
