#!/usr/bin/env python3
"""
National Semiconductor NA32032 CPI Stack Model
...
class CPIStackResult:
    ...
    def compute_totals(self):
        self.cpi_total = self.cpi_base+ self.cpi_prefetch+ self.cpi_branch + self.cpi_memory
        self.ipc = 1.0 / self.cpi_total if self.cpi_total > 0 else 0
        self.mips = 10.0 * self.ipc
...
class NationalSemiconductorNa32032CPIStackModel:
    """
    CPI Stack Model for National Semiconductor NA32032.
    ...
    def print_result(self, result: CPIStackResult):
        ...
        print(f"\n{'='*55}")
        print(f"CPI STACK: National Semiconductor NA32032")
        print(f"{'='*55}")
...
def main():
    model = NationalSemiconductorNa32032CPIStackModel()
    
    print("\n" + "="*55)
    print("National Semiconductor NA32032 CPI STACK MODEL")
    print("="*55)
