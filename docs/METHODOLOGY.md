...
This document describes the methodology used to create performance models for the 80 historical microprocessors in this collection. The approach combines architectural knowledge with queueing theory to achieve <5% CPI prediction accuracy.
...
This approach has successfully modeled **80 processors** from 1971-1994 with **average CPI error of 1.55%**.
