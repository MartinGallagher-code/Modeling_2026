...
Grey-box queueing model for the Intel 8051 microprocessor (1980).
...
TIMING_CATEGORIES = {
    ...
    'branch': {
        'cycles': 24,
        'weight': 0.1,
        'description': 'SJMP, AJMP',
        'source': 'Intel MCS-51 Users Manual'
    },
    'call_return': {
        'cycles': 24,
        'weight': 0.05,
        'description': 'ACALL, RET',
        'source': 'Intel MCS-51 Users Manual'
    },
    'bit_ops': {
        'cycles': 12,
        'weight': 0.08,
        'description': 'SETB, CLR, CPL',
        'source': 'Intel MCS-51 Users Manual'
    },
    'multiply': {
        'cycles': 48,
