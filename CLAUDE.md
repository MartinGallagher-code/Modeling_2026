...
This repository contains grey-box queueing models for 467 historical microprocessors (1970-1995) organized into 19 manufacturer/family directories. Each model predicts processor performance (CPI, IPC, IPS) using category-based instruction timing and M/M/1 queueing theory.

**Goal**: Achieve <2% CPI prediction error for each model compared to documented/expected values. All 467 models currently pass.
