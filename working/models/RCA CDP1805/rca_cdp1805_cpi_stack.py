...
class RcaCdp1805CPIStackModel:
    """
    CPI Stack Model for RCA CDP1805.
...
def main():
    model = RcaCdp1805CPIStackModel()
    
    print("\n" + "="*55)
    print("RCA CDP1805 CPI STACK MODEL")
    print("="*55)
