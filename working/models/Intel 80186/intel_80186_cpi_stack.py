...
class Intel80186CPIStackModel:
    """
    CPI Stack Model for Intel 80186.
...
def main():
    model = Intel80186CPIStackModel()
    
    print("\n" + "="*55)
    print("Intel 80186 CPI STACK MODEL")
    print("="*55)
