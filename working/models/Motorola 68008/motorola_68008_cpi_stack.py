#!/usr/bin/env python3
"""
Motorola 68008 CPI Stack Model
...
class Motorola68008CPIStackModel:
    """
    CPI Stack Model for Motorola 68008.
    ...
    def print_result(self, result: CPIStackResult):
        ...
        print(f"\n{'='*55}")
        print(f"CPI STACK: Motorola 68008")
        print(f"{'='*55}")
...
def main():
    model = Motorola68008CPIStackModel()
    
    print("\n" + "="*55)
    print("Motorola 68008 CPI STACK MODEL")
    print("="*55)
