...
class Motorola6801CPIStackModel:
    """
    CPI Stack Model for Motorola 6801.
    ...
    def print_result(self, result: CPIStackResult):
        ...
        print(f"\n{'='*55}")
        print(f"CPI STACK: Motorola 6801")
        print(f"{'='*55}")
...
def main():
    model = Motorola6801CPIStackModel()
    
    print("\n" + "="*55)
    print("Motorola 6801 CPI STACK MODEL")
    print("="*55)
