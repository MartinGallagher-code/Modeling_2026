...
class CPIStackResult:
    ...
    def compute_totals(self):
        self.cpi_total = self.cpi_base+ self.cpi_prefetch+ self.cpi_branch + self.cpi_memory+ self.cpi_pipeline
...
class Intel80386CPIStackModel:
    """
    CPI Stack Model for Intel 80386.
    ...
    def predict(self, workload: Workload = None) -> CPIStackResult:
        ...
        result.cpi_pipeline = result.cpi_base * 0.02 * (4 - 2)
...
def main():
    model = Intel80386CPIStackModel()
    
    print("\n" + "="*55)
    print("Intel 80386 CPI STACK MODEL")
    print("="*55)
