...
PROCESSOR_SPECS = {
    ...
    'i80486': {'year': 1989, 'clock': 25.0, 'transistors': 1200000, 'data': 32, 'addr': 32, 'mfr': 'Intel',
               'pipeline_depth': 5, 'icache_kb': 8, 'dcache_kb': 0},
    'i860': {'year': 1989, 'clock': 25.0, 'transistors': 1000000, 'data': 64, 'addr': 32, 'mfr': 'Intel',
             'pipeline_depth': 5, 'icache_kb': 4, 'dcache_kb': 8},
    'pentium': {'year': 1993, 'clock': 60.0, 'transistors': 3100000, 'data': 32, 'addr': 32, 'mfr': 'Intel',
                'pipeline_depth': 5, 'icache_kb': 8, 'dcache_kb': 8},
    ...
    # Motorola Cache/RISC
    'm68030': {'year': 1987, 'clock': 16.0, 'transistors': 273000, 'data': 32, 'addr': 32, 'mfr': 'Motorola',
               'pipeline_depth': 5, 'icache_kb': 0.256, 'dcache_kb': 0.256},
    'm68040': {'year': 1990, 'clock': 25.0, 'transistors': 1200000, 'data': 32, 'addr': 32, 'mfr': 'Motorola',
               'pipeline_depth': 6, 'icache_kb': 4, 'dcache_kb': 4},
    'm68060': {'year': 1994, 'clock': 50.0, 'transistors': 2500000, 'data': 32, 'addr': 32, 'mfr': 'Motorola',
               'pipeline_depth': 10, 'icache_kb': 8, 'dcache_kb': 8},
    ...
    'arm2': {'year': 1986, 'clock': 8.0, 'transistors': 27000, 'data': 32, 'addr': 26, 'mfr': 'Acorn',
             'pipeline_depth': 3, 'icache_kb': 0, 'delayed_branch': False},
    'arm3': {'year': 1989, 'clock': 25.0, 'transistors': 310000, 'data': 32, 'addr': 26, 'mfr': 'Acorn',
             'pipeline_depth': 3, 'icache_kb': 4, 'delayed_branch': False},
    'arm6': {'year': 1991, 'clock': 30.0, 'transistors': 35000, 'data': 32, 'addr': 32, 'mfr': 'ARM Ltd',
             'pipeline_depth': 3, 'icache_kb': 4, 'delayed_branch': False},
    ...
    'mips_r3000': {'year': 1988, 'clock': 20.0, 'transistors': 150000, 'data': 32, 'addr': 32, 'mfr': 'MIPS',
                   'pipeline_depth': 5, 'icache_kb': 64, 'dcache_kb': 64, 'delayed_branch': True},
    ...
    'sun_sparc': {'year': 1987, 'clock': 14.0, 'transistors': 80000, 'data': 32, 'addr': 32, 'mfr': 'Sun',
              'pipeline_depth': 4, 'icache_kb': 4, 'dcache_kb': 4, 'delayed_branch': True, 'register_windows': 8},
    'sun_spark': {'year': 1987, 'clock': 14.0, 'transistors': 80000, 'data': 32, 'addr': 32, 'mfr': 'Sun',
              'pipeline_depth': 4, 'icache_kb': 4, 'dcache_kb': 4, 'delayed_branch': True, 'register_windows': 8},
    ...
    # DEC Alpha
    'alpha': {'year': 1992, 'clock': 150.0, 'transistors': 1680000, 'data': 64, 'addr': 64, 'mfr': 'DEC',
              'pipeline_depth': 7, 'icache_kb': 8, 'dcache_kb': 8, 'delayed_branch': False},
    'alpha21064': {'year': 1992, 'clock': 150.0, 'transistors': 1680000, 'data': 64, 'addr': 64, 'mfr': 'DEC',
                   'pipeline_depth': 7, 'icache_kb': 8, 'dcache_kb': 8, 'delayed_branch': False},
    
    # HP PA-RISC
    'pa_risc': {'year': 1986, 'clock': 8.0, 'transistors': 115000, 'data': 32, 'addr': 32, 'mfr': 'HP',
                'pipeline_depth': 5, 'icache_kb': 4, 'dcache_kb': 4, 'delayed_branch': True},
    'hp_pa_risc': {'year': 1986, 'clock': 8.0, 'transistors': 115000, 'data': 32, 'addr': 32, 'mfr': 'HP',
                   'pipeline_depth': 5, 'icache_kb': 4, 'dcache_kb': 4, 'delayed_branch': True},
    
    # PowerPC
    'powerpc': {'year': 1993, 'clock': 60.0, 'transistors': 2800000, 'data': 32, 'addr': 32, 'mfr': 'AIM',
                'pipeline_depth': 4, 'icache_kb': 32, 'dcache_kb': 32, 'delayed_branch': False},
    'ppc601': {'year': 1993, 'clock': 60.0, 'transistors': 2800000, 'data': 32, 'addr': 32, 'mfr': 'AIM',
               'pipeline_depth': 4, 'icache_kb': 32, 'dcache_kb': 32, 'delayed_branch': False},
    'aim_ppc_601': {'year': 1993, 'clock': 60.0, 'transistors': 2800000, 'data': 32, 'addr': 32, 'mfr': 'AIM',
                    'pipeline_depth': 4, 'icache_kb': 32, 'dcache_kb': 32, 'delayed_branch': False},
    'aim__ppc_601': {'year': 1993, 'clock': 60.0, 'transistors': 2800000, 'data': 32, 'addr': 32, 'mfr': 'AIM',
                     'pipeline_depth': 4, 'icache_kb': 32, 'dcache_kb': 32, 'delayed_branch': False},
}
